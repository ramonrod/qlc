...
def get_trac_wiki_book_article(bibtex_key):
    try:
        ...
        connection.close()
        wiki_text = wiki_text + "<p><small>Edit this page at <a href=\"http://trac.cidles.eu/wiki/%s\">http://trac.cidles.eu/wiki/%s</a></small></p>" % (bibtex_key, bibtex_key)
